...
export const ACHIEVEMENTS = [
  ...
  },
  {
    id:     "xp_1200",
    name:   "Élite",
    desc:   "Alcanza 1200 XP — el rango más alto",
    icon:   "🌟",
    rarity: "legendary",
    check:  d => d.xp >= 1200,
  },
  ...
  {
    id:     "empresa_mes1",
    name:   "Primer Mes Contable",
    desc:   "Completa el primer mes en Distribuidora Andes",
    icon:   "📋",
    rarity: "common",
    check:  d => (d.empresaMes || 0) >= 1,
  },
  {
    id:     "empresa_contador",
    name:   "Contador Oficial",
    desc:   "Alcanza el título de Contador en la empresa",
    icon:   "📊",
    rarity: "uncommon",
    check:  d => (d.empresaMes || 0) >= 3,
  },
  {
    id:     "empresa_senior",
    name:   "Contador Senior",
    desc:   "Alcanza el título de Contador Sr.",
    icon:   "💼",
    rarity: "rare",
    check:  d => (d.empresaMes || 0) >= 6,
  },
  {
    id:     "empresa_cfo",
    name:   "Director Financiero",
    desc:   "Alcanza el título de CFO",
    icon:   "👔",
    rarity: "legendary",
    check:  d => (d.empresaMes || 0) >= 10,
  },
